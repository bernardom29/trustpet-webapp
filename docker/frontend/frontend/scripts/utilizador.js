...
var vm = new Vue({
    ...
    methods: {
        registoPetsitter: async function () {
            const response = await fetch("http://localhost:8080/trustpet_war_exploded.war/RegistarPetsitter", {
                headers: {
        ...
        login: async function () {
            if (this.email === '' || this.password === '') {
                ...
                const response = await fetch("http://localhost:8080/trustpet_war_exploded.war/Autenticar", {
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8'
                    },
                    method: "POST",
        ...
        registoDono: async function () {
            const response = await fetch("http://localhost:8080/trustpet_war_exploded.war/RegistarDono", {
                headers: {
                    'Content-Type': 'application/json; charset=utf-8'
                },
                method: "POST",
