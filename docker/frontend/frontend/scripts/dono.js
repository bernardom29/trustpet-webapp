...
Vue.component('rm-animal', {
    ...
    methods: {
        removerAnimal: async function (id) {
            const response = await fetch("http://localhost:8080/trustpet_war_exploded.war/EditarAnimal", {
                headers: {
                    'Content-Type': 'application/json; charset=utf-8'
                },
                method: "POST",
    ...
    created: async function () {
        if (localStorage.token) {
            ...
            if (content.email) {
                ...
                //Fetch dos animais
                const responseAnimal = await fetch("http://localhost:8080/trustpet_war_exploded.war/ConsultarAnimais", {
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'Token': localStorage.token
                    },
                ...
                if (window.location.href == "http://localhost/consultarPetsitters.html") {
                    ...
                    const responsePetsitters = await fetch("http://localhost:8080/trustpet_war_exploded.war/ConsultarPetsitters", {
                        headers: {
                            'Content-Type': 'application/json; charset=utf-8',
                            'Token': localStorage.token
                        },
    ...
    methods: {
        registarPedido: async function () {
            if (this.animaisSelecionados.length == 0) {
                ...
                const response = await fetch("http://localhost:8080/trustpet_war_exploded.war/RegistarPedido", {
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'Token': localStorage.token
                    },
        ...
        selServicos: async function () {
            ...
            if (!ok) {
                ...
                const response = await fetch("http://localhost:8080/trustpet_war_exploded.war/SelServicos", {
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'Token': localStorage.token
                    },
        ...
        selPetsitter: async function (email) {
            console.log(email)
            const response = await fetch("http://localhost:8080/trustpet_war_exploded.war/SelPetsitter", {
                headers: {
                    'Content-Type': 'application/json; charset=utf-8',
                    'Token': localStorage.token
                },
